  ...
  return (
    <>
      ...
      <div className="car-design-cover-container">
        <img
          src="public/pictures/carDesignOverlay.webp"
        ...
        <div className="car-design-overlay">
          <div className="car-design-text-overlay">
            <h1 className="display-1">Designed for the Best Riding</h1>
          </div>
        </div>
      </div>
